...
function Survey2() {
    ...
    // Sample Instructions
    const instructions = [
    { I: "Instruction1 (On a scale of 1 to 5, kindly rate your agreement on the following factors you think contribute to the student's success in college this semester, where:)" },
    { I: "adfasdfasfd" },
